...
\begin{figure}[H]
  \centering
  \subfloat[]{\includegraphics[width=\textwidth]{img/uni_linear_bsplines}}\caption{\textit{B-splines of degree 1}}\label{fig:overlapping-linear-bsplines}\hfill
    \subfloat[]{\includegraphics[width=\textwidth]{img/uni_cubic_bsplines}}\caption{\textit{B-splines of degree 2}}\label{fig:overlapping-cubic-bsplines}
   \vspace*{3mm}
...
\captionsetup[subfigure]{labelformat=empty}
  \centering
  \subfloat[\textit{B-splines of degree 1}]{\includegraphics[width=.5\textwidth]{img/bicubic_basis_function}}\hfill
    \subfloat[\textit{B-splines of degree 2}]{\includegraphics[width=.5\textwidth]{img/bicubic_bspline_contour}}
   \vspace*{3mm}
...
\begin{figure}[H] 
  \centering
  \subfloat[]{\includegraphics[width=.5\textwidth]{img/pspline_pord2_xsmall_lambda}}
    \subfloat[]{\includegraphics[width=.5\textwidth]{img/pspline_pord2_small_lambda}} \hfill
      \subfloat[]{\includegraphics[width=.5\textwidth]{img/pspline_pord2_medium_lambda}}
    \subfloat[]{\includegraphics[width=.5\textwidth]{img/pspline_pord2_large_lambda}} 
   \vspace*{3mm}
...
%\begin{figure}[H] 
  \centering
  \subfloat[$d = 0$]{\includegraphics[width=.5\textwidth]{img/PS_penalty_section_figure_6_order_0}}
    \subfloat[$d = 1$]{\includegraphics[width=.5\textwidth]{img/PS_penalty_section_figure_6_order_1}} \hfill
      \subfloat[$d = 2$]{\includegraphics[width=.5\textwidth]{img/PS_penalty_section_figure_6_order_2}}
    \subfloat[$d = 3$]{\includegraphics[width=.5\textwidth]{img/PS_penalty_section_figure_6_order_3}} 
   \vspace*{3mm}
