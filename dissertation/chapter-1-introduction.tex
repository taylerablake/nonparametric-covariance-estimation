...
%%---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
\subsection{Shrinking the sample covariance matrix} \label{chapter-1-shrinking-the-sample-cov}
...
\begin{equation} 
\mathcal{s}_\lambda\left( z \right) = \textup{sign}\left(\sigma\right) \left(\sigma  - \lambda\right)_+.
\end{equation}
...
\subsubsection{Smoothing parameter selection for element-wise shrinkage estimators} \label{chapter-1-smoothing-parameter-estimation-elementwise-shrinkage-estimators}
