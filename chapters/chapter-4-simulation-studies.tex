...
Standard errors of the risk estimates are given in Table~\ref{table:}
...
\subsection{Results}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Simulation study 1: complete data}
...
M & \% subsampling & $\hat{\Delta}_1$ & $se (\hat{\Delta}_1)$& $\hat{\Delta}_2$ & $se (\hat{\Delta}_2)$ \\ 
  \hline
...
\centering
\begin{tabular}{rrrrrr}
M & \% subsampling & $\hat{\Delta}_1$ & $se (\hat{\Delta}_1)$& $\hat{\Delta}_2$ & $se (\hat{\Delta}_2)$ \\   \hline
...
\subsection{Risk estimates and corresponding standard errors for simulation study 1.}
...
\begin{tabular}{lrrrrrrrrrr}
  \hline
Model & N & M & $\hat{\Delta}_1(\hat{\Sigma}_{SS})$ & $se( \hat{\Delta}_1(\hat{\Sigma}_{SS}))$ & $\hat{\Delta}_2(\hat{\Sigma}_{SS})$  & $se( \hat{\Delta}_2(\hat{\Sigma}_{SS}))$ &$\hat{\Delta}_1(S)$ & $se(\hat{\Delta}_1(S))$ &$\hat{\Delta}_2(S)$  & $se(\hat{\Delta}_1(S))$\\ 
  \hline
1 & 50 & 10 & 0.0023 & 0.0006 & 0.0843 & 0.0099 & 0.3915 & 0.0262 & 1.1924 & 0.0348 \\ 
  ...
  1 & 100 & 20 & 0.0003 & 0.0000 & 0.0421 & 0.0034 & 0.4025 & 0.0199 & 2.3150 & 0.0273 \\ 
  1 & 100 & 30 & 0.0002 & 0.0000 & 0.0407 & 0.0040 & 0.5914 & 0.0224 & 5.2940 & 0.0476 \\ 
    \hdashline \\
      \hdashline
