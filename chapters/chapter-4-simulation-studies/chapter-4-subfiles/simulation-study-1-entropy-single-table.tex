...
\caption{Estimated entropy risk via 100 multivariate normal simulations for our smoothing spline ANOVA estimator and P-spline estimator, the oracle estimator, the parametric polynomial estimator,  sample covariance matrix, tapered sample covariance matrix, and soft thresholding estimator.} \\
